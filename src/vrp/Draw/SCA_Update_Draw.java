...
public class SCA_Update_Draw {
    ...
    public SCA_Update_Draw(f_xj iff, double iLower[], double iUpper[], int imaxiter, int iN) {
        maxiter = imaxiter;
        ff = iff;
        Lower = iLower;
        Upper = iUpper;
...
//                }
    ...
    public double getRes() throws IOException {
        double[][] in=solution();
        //ExcelUtils.fillForDrawFunctionToExcel(F_min, 9, maxiter);
